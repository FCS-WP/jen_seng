          ...
          <MediaUploadCheck>
            <MediaUpload
              ...
              render={({ open }) => (
                ...
                >
                  {!bgMediaId
                    ? __("Select BG Image", "ai-zippy")
                    : __("Replace BG Image", "ai-zippy")}
                </Button>
              )}
            />
          </MediaUploadCheck>
        ...
        <div className="home-hero__content">
          ...
          <div className="home-hero__ctas">
            <span className="btn-primary">
              {primaryBtnText || __("Button", "ai-zippy")}
            </span>
            <span className="btn-outline">
              {secondaryBtnText || __("Button", "ai-zippy")}
            </span>
          </div>
